    ...
    <body>
        <div>
            ...
            <form action="bookhotel" method="POST">
                ...
                <input style="padding-left:15px;" type="text" name="hid" id="hid" value="Park" readonly="true" class="c1" /><br/>
