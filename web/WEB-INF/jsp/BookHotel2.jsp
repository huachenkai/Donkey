...
<html>
    ...
    <body>
        <div>
            <!--<a href="sanya" id="back">Back</a><br/>-->
            <form action="bookhotel" method="POST">
                ...
                <input style="padding-left:15px;" type="text" name="hid" id="hid" value="Sanya" readonly="true" class="c1" /><br/>
