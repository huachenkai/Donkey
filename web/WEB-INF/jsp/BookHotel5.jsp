...
<html>
    ...
    <body>
        <div>
            <!--<a href="zhuzhu" id="back">Back</a><br/>-->
            <form action="bookhotel" method="POST">
                ...
                <input style="padding-left:15px;" type="text" name="hid" id="hid" value="Zhuzhu" readonly="true" class="c1" /><br/>
