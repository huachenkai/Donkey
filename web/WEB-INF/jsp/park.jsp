...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form action="bookPark" method="GET">
        ...
        <div style=" height: 500px; margin: 0 ;padding: 0; border: 0;">
            ...
            <div  style="width:550px;height: 500px;float:left; margin-left: 150px;" >
                ...
                <img src="/Donkey1/Galleria/images/标间4.jpg" alt="" height="300" width="450"/> 
                <h4>Price</h4>
                <p style=" color: red">RMB 1100.00</p>				
            </div>
            <div  style="width:550px; height: 500px;float:left; margin-left: 80px; ">
                <h3>This is King Size Room</h3>
                <img src="/Donkey1/Galleria/images/大床房4.jpg" alt="" height="300" width="450"/>
                <h4>Price</h4>
                <p style=" color: red">RMB 1300.00</p>
            </div>
        </div>
        <div style=" height: 500px; margin: 0 ;padding: 0; border: 0;">
            <div style=" height: 50px"></div>
            <div  style="width:550px;height: 500px;float:left; margin-left: 150px;" >
                ...
                <img src="/Donkey1/Galleria/images/酒店大厅.jpg" alt="" height="300" width="450"/> 				
            </div>
            <div  style="width:550px; height: 500px;float:left; margin-left: 80px;">
