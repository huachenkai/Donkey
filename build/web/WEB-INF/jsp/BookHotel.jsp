...
<html>
    ...
    <body>
        <div>
            <!--<a href="Sheraton" id="back">Back</a><br/>-->
            <form action="bookhotel" method="POST">
                ...
                <input style="padding-left:15px;" type="text" name="hid" id="hid" value="Sheraton" readonly="true" class="c1" /><br/>
