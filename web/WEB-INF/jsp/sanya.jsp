...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form action="bookSanya" method="GET">
        ...
        <div style=" height: 500px; margin: 0 ;padding: 0; border: 0;">
            ...
            <div  style="width:550px;height: 500px;float:left; margin-left: 150px;" >
                ...
                <img src="/Donkey1/Galleria/images/标间3.jpg" alt="" height="300" width="450"/> 
                <h4>Price</h4>
                <p style=" color: red">RMB 1500.00</p>				
            </div>
            <div  style="width:550px; height: 500px;float:left; margin-left: 80px; ">
                <h3>This is King Size Room</h3>
                <img src="/Donkey1/Galleria/images/大床房3.jpg" alt="" height="300" width="450"/>
                <h4>Price</h4>
                <p style=" color: red">RMB 1600.00</p>
            </div>
        </div>
        <div style=" height: 500px; margin: 0 ;padding: 0; border: 0;">
            <div style=" height: 50px"></div>
            <div  style="width:550px;height: 500px;float:left; margin-left: 150px;" >
                ...
                <img src="/Donkey1/Galleria/images/酒店大堂4.jpg" alt="" height="300" width="450"/> 				
            </div>
            <div  style="width:550px; height: 500px;float:left; margin-left: 80px;">
                <h3>This is the Restaurant</h3>
                <img src="/Donkey1/Galleria/images/酒店餐厅3.jpg" alt="" height="300" width="450"/>
            </div>
        </div>
    </body>
</html>
